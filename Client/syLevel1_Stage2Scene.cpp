...
namespace sy
{
	Level1_Stage2Scene::Level1_Stage2Scene()
		: mPixelBG(nullptr)
	{
	}
	...
	void Level1_Stage2Scene::Initialize()
	{
		// 적 생성
	...
	void Level1_Stage2Scene::Update()
	{
		Scene::Update();
	...
	void Level1_Stage2Scene::Render(HDC hdc)
	{
		Scene::Render(hdc);
	}

	void Level1_Stage2Scene::Enter()
	{
		// 플레이어 설정
