...
namespace sy
{
	...
	void CushyCloudScene::Initialize()
	{
		...
		LevelMarkUIAni->CreateAnimation(Tex, L"LevelMarkUI", Vector2(222.f, 905.f), Vector2(96.f, 15.f), Vector2(113.f, 0.f), 1, 1);
		...
		LevelNameUIAni->CreateAnimation(Tex, L"LevelNameUI", Vector2(2.f, 910.f), Vector2(202.f, 32.f), Vector2(202.f, 0.f), 1, 1);
	...
	void CushyCloudScene::CreateStageUI()
	{
		// StageExit UI 생성 
	...
	void CushyCloudScene::StageExit()
	{
