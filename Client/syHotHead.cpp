...
namespace sy
{
	...
	void HotHead::Initialize()
	{
		...
		animator->CreateAnimation(Enemies_Right, L"HotHead_Right_Death", Vector2(0.f, 3350.f), Vector2(23.f, 21.f), Vector2(23.f, 0.f), 1.f, 1);
		animator->CreateAnimation(Enemies_Left, L"HotHead_Left_Death", Vector2(459.f, 3350.f), Vector2(23.f, 21.f), Vector2(-23.f, 0.f), 1.f, 1);

		animator->CreateAnimation(Enemies_Right, L"HotHead_Right_Attack", Vector2(8.f, 3284.f), Vector2(24.f, 21.f), Vector2(24.f, 0.f), 0.2f, 3);
		animator->CreateAnimation(Enemies_Left, L"HotHead_Left_Attack", Vector2(450.f, 3284.f), Vector2(24.f, 21.f), Vector2(-24.f, 0.f), 0.2f, 3);

		animator->PlayAnimation(L"HotHead_Right_Walk", true);
