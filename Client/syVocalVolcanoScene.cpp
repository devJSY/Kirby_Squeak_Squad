...
namespace sy
{
	...
	void VocalVolcanoScene::Initialize()
	{
		...
		LevelAni->CreateAnimation(Tex, L"Level", Vector2(222.f, 941.f), Vector2(96.f, 15.f), Vector2(113.f, 0.f), 1, 1);
		...
		LevelNameAni->CreateAnimation(Tex, L"LevelName", Vector2(2.f, 978.f), Vector2(202.f, 32.f), Vector2(202.f, 0.f), 1, 1);
